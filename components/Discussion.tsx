    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-950">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
        {loading && (
          <div className="flex items-center justify-center h-full">
            <div className="text-sm text-gray-400 dark:text-gray-500">Loading discussion...</div>
          </div>
        )}
      ...
      <div className="px-5 py-4 border-t border-gray-100 dark:border-gray-800">
        ...
        <div className="flex gap-2">
          <input
            className="flex-1 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 dark:placeholder-gray-600 transition-all"
          ...
          <button
            onClick={handleSend}
            disabled={!input.trim()}
            className="px-4 py-2.5 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-semibold rounded-xl disabled:opacity-40 hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors"
          >
            Post
          </button>
        </div>
